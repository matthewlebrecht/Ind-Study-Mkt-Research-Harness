...
| THEME-05 | `digital_transformation_process` | **52** | 36 | 9 | 7 | 9 | 19 | 24 | 0 | **45** | 23 | 29 | — | 6 | 0 | **substantive evidence** |
...
| | **total** | **220** | 143 | 33 | 44 | 50 | 56 | 114 | 0 | **176** | 103 | | | 109 | 0 | |
...
| THEME-05 | `digital_transformation_process` | `exec_quote_reported` IC2, `executive_public_statement` IC2, `first_party_announcement` IC1, `job_board_third_party` IC3 presence-only, `job_posting` IC3 presence-only | no | H-EXECVOICE-01 (6), H-FIRSTPARTY-01 (28), H-JOBPOST-01 (6), H-PRODUCTQUALITY-01 (3), H-SELLERCONTENT-01 (7), H-TRADEPRESS-01 (2) |
...
- **The low-grade tier carries much of this evidence.** 103 of 176 valid buyer-side rows are low-grade (convention 41: grade C, marked excerpt, admitted because the referent is right but the corroboration is thin). At or above half their buyer rows: THEME-01 (6/9), THEME-04 (26/28), THEME-05 (23/45), THEME-06 (7/13), THEME-07 (2/3), THEME-09 (9/10), THEME-10 (7/8). A `substantive evidence` state counts these rows; whether a per-theme finding should is a judgment this pull does not make.
...
- **Invalid rows excluded: 109** across all themes (112 determinations exist portfolio-wide; the rest sit on non-theme topics or quarantined rows).
